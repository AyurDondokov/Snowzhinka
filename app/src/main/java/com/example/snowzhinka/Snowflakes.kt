package com.example.snowzhinka
...
open class Snowflakes(ctx: Context) : View(ctx) {
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        snow = Array(10) { Snowflake(x = r.nextFloat() * w, y =  r.nextFloat() * h,
            velocity = 15 + 5 * r.nextFloat(), radius = 30 + 20 * r.nextFloat(),
            Color.rgb( r.nextFloat()*255F,r.nextFloat()*255F,r.nextFloat()*255F)) // TODO: сделать снежинки разного оттенка
        }
